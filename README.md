...
- [GCC](https://gcc.gnu.org/) — The GCC compiler has [static analysis capabilities](https://gcc.gnu.org/onlinedocs/gcc/Static-Analyzer-Options.html) since version 10.
